<template>
  ...
  >
    <template slot="side">
      <aside>
        <div
          class="sticky flex flex-col justify-between top-[50px] lg:h-[60vh]"
        >
          <div>
...
export default {
  ...
  async mounted() {
    this.$store.commit("menu/setIsElection", true);
  ...
  methods: {
    buildUrls() {
      ...
      crawlMenu(this.otherMenu.nodes, [], false);
      crawlMenu(this.menu.nodes, [], true);
